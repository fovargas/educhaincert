import { IAgentContext, IDIDManager, IKeyManager, IMessage, IMessageHandler, IPluginMethodMap, IResolver } from '@veramo/core-types';
import { IPackDIDCommMessageArgs, ISendDIDCommMessageArgs, ISendMessageDIDCommAlpha1Args, IUnpackDIDCommMessageArgs } from '../didcomm.js';
import { DIDCommMessageMediaType, IPackedDIDCommMessage, IUnpackedDIDCommMessage } from './message-types.js';
/**
